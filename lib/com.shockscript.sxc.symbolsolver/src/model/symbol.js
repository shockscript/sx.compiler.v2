...
export class Value extends Symbol {
    ...
    convertConstant(toType) {
        ...
        else if (this.isEmptyConstant && (toType.containsNull || toType == this.host.anyType)) {
        ...
        else if (this.isNothingConstant && (toType.containsNull || toType == this.host.anyType)) {
            return this.host.factory.createNothingConstant(toType);
        }
        else if (this.isNullConstant && (toType.containsNull || toType == this.host.anyType)) {
...
/**
 * Empty constant. Associated value type can be `Any`, `Null` or nullable.
 */
...
/**
 * Nothing constant. Associated value type can be `Any`, `Null` or nullable.
 */
...
/**
 * Null constant. Associated value type can be `Any`, `Null` or nullable.
 */
...
export class FunctionSignature extends Symbol {
    ...
    toString() {
        ...
        if (this.returnType == this.host.nullType) {
            return "Sub(" + p.join(', ') + ")";
        }
...
export class Host {
    ...
    getRootModule(name) {
        return this._rootModules.get(name.toLowerCase()) || null;
    }
    hasRootModule(name) {
