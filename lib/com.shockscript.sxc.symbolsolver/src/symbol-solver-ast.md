...
- [ ] Constant Expressions
  - [x] Identifier (`Ident`)
  - [x] Identifier or call (`IdentOrCall`)
  - [x] String literal  (`StrLtr`)
  - [x] Boolean literal (`BoolLtr`)
  - [x] Decimal literal (`DecLtr`)
  - [x] Long literal (`LongLtr`)
  - [x] Nothing literal (`NothingLtr`)
  - [x] Null literal (`NullLtr`)
  - [x] Empty literal (`EmptyLtr`)
  - [x] Parentheses expression (`ParensExp`)
  - [x] Dot operator: member or call operator (`MemberOrCallOp`)
  - [x] Dot operator: member-only (`MemberOp`)
